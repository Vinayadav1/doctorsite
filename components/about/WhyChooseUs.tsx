  ...
  const reasons = [
    {
      ...
      description: 'Deep understanding of medical industry needs and patient expectations',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      title: 'Fast Delivery',
      description: 'Launch your professional website in just 2-3 weeks',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      description: 'No hidden fees, clear pricing structure with flexible plans',
    },
    {
      icon: (
        <svg className="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <div className="max-w-7xl mx-auto px-6">
        ...
        >
          <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">
            Why Choose DoctorSite?
          </h2>
          <p className="text-lg text-gray-600 max-w-2xl mx-auto">
            We combine healthcare expertise with cutting-edge technology
          </p>
        </motion.div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {reasons.map((reason, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="bg-white rounded-2xl p-6 h-full hover:shadow-xl transition-all duration-300">
